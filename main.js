...
var NtfyLanSyncRuntime = (() => {
  ...
  var INCREMENTAL_PATH_BATCH_SIZE = Number.MAX_SAFE_INTEGER;
  ...
  var NtfyLanSync = class {
    ...
    startBackgroundFilesystemReconciliation() {
      ...
      const promise = (async () => {
        ...
        let rounds = 0;
        const reconciledPaths = /* @__PURE__ */ new Set();
...
class NtfyLanSyncDetailsModal extends Modal {
  ...
  renderFile(parent, file, chinese) {
    ...
    const stateIcons = { pending: "circle", syncing: "loader-circle", complete: "circle-check", deferred: "refresh-cw", error: "triangle-alert" };
    const row = parent.createDiv({ cls: `obsidian-ntfy-lan-details-file is-${file.state}` });
